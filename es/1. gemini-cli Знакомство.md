...
*   Identificó la causa principal como un error de serialización JSON (en este caso, la función asíncrona `create_session()` no fue llamado con `await`).
