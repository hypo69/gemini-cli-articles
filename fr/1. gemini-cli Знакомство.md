...
Vous pouvez ajouter des instructions spéciales pour l'AI pour un projet spécifique en
...
Essentiellement, le MCP est une norme ouverte qui permet aux développeurs d'ajouter de nouveaux outils et capacités à l'AI en exécutant un serveur avec lequel la CLI peut interagir. Dans Gemini CLI, vous pouvez configurer "MCP serveurs" dans un fichier de paramètres JSON, et la CLI les traitera comme des outils supplémentaires qu'elle peut utiliser.
